...
excerpt: "The mistake that keeps derailing projects: optimising code before you know what is slow, and paying for it in clarity."
date: "2024-09-14"
readingTime: 4 min read
category: Craft
cover: /images/blog/50fa9cf5f0c1.png
featured: false
tags: ["Performance", "C#", "ASP.NET Core"]
canonical: https://sudi.dev/code-smart-not-fast-avoiding-premature-optimization
---
