...
excerpt: "Adding a real data source to a Minimal API — wiring up EF Core with SQLite, from DbContext through to dependency injection."
date: "2023-11-14"
readingTime: 5 min read
category: .NET
cover: /images/blog/82081135ac6b.png
featured: false
tags: ["EF Core", "SQLite", "Minimal APIs"]
canonical: https://sudi.dev/adding-entity-framework-core-and-sqlite
---
