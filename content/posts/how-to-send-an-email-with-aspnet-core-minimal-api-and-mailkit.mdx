...
excerpt: "Sending email from an ASP.NET Core Minimal API with MailKit, built from scratch rather than pasted from a snippet."
date: "2023-07-10"
readingTime: 5 min read
category: .NET
cover: /images/blog/95cf9f51e7e5.jpeg
featured: false
tags: ["MailKit", ".NET", "Minimal APIs"]
canonical: https://sudi.dev/how-to-send-an-email-with-aspnet-core-minimal-api-and-mailkit
---
